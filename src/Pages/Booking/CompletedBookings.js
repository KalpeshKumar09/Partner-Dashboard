...
const CompletedBookings = () => {
  ...
  return (
    <div className="flex justify-center py-12 overflow-scroll">
        ...
        <div className="px-2 flex gap-2 flex-col md:px-4">
          {completedBookings.map((booking) => (
            <Link
              ...
              className="flex gap-4 flex-row justify-between items-center w-full rounded-md bg-white shadow-[0px_4px_4px_rgba(156,_154,_154,_0.25)] overflow-hidden"
            >
